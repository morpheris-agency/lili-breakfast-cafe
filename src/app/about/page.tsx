        ...
        <div className="max-w-5xl mx-auto px-6 md:px-12 py-12 md:py-24 overflow-hidden">
            ...
            <div className="text-center mb-24">
                <motion.div
                    ...
                    className="inline-block px-4 py-2 bg-accent-mango/20 text-accent-mango font-heading font-bold rounded-full text-sm mb-6"
                >
                    Our Story
                </motion.div>
                <motion.h1
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-32">
                ...
                >
                    ...
                    <div className="space-y-4 text-text-dark/80 font-body text-lg leading-relaxed">
                        ...
                        <p className="font-heading font-bold text-accent-mango text-xl mt-4 italic">
            ...
            >
                ...
                <h3 className="text-3xl md:text-5xl font-heading font-bold text-text-dark mb-6">
                    Come say hi!
                </h3>
