    ...
    return (
        <div className="w-full aspect-video rounded-[3rem] bg-bg-secondary overflow-hidden relative shadow-inner p-4 md:p-8 flex flex-col justify-end">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center">
                ...
                <div className="absolute -top-12 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-2xl shadow-xl font-script font-normal text-text-dark whitespace-nowrap">
                    We are here! ✨
                </div>
            </div>
            ...
            <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-4 w-full self-end bg-white/50 backdrop-blur-lg p-4 rounded-3xl items-center border border-white/40">
                <div className="hidden md:block col-span-2">
                    <p className="font-script font-normal text-text-dark/80 px-2 line-clamp-2 leading-tight">
                ...
                <div className="col-span-2 flex justify-end">
                    <a
                        ...
                        className="inline-flex items-center justify-center bg-accent-mango text-white font-script font-normal px-6 py-3 rounded-full hover:bg-[#F2AE00] transition-colors w-full sm:w-auto shadow-md hover:shadow-lg active:scale-95"
                    >
                        Open in Google Maps
                    </a>
                </div>
